...
import { IPmd, IPmdFileData, IPmdFileMetaData, IPmdViolation, IPmdViolationMetaData } from "../../../src/model/pmd";
import BuildDiagnosticsStrategy from "../../../src/service/pipeline/BuildDiagnosticsStrategy";
